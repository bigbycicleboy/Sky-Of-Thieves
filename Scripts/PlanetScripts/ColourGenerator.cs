...
public class ColourGenerator
{
    ...
    {
        float heightPercent = pointOnUnitSphere.magnitude - 1f;
        ...
        biomeIndex = biomeIndex / Mathf.Max(1, numBiomes - 1);
        biomeIndex = Mathf.Clamp(biomeIndex, 0.5f, 1);
        return biomeIndex;
    }
    ...
    public float ElevationPercentFromHeight(float height)
    {
        return Vector4.Normalize(new Vector4(height, 0, 0, 0)).x;
    }
}